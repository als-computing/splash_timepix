        ...
        while True:
            ...
            if is_data_message:
                ...
                try:
                    ...
                    print(f"WARNING: Expected second part for data message but none received")
                    continue
                finally:
            ...
            if msg_type == 'start':
                ...
                print(f"   Detector size: {metadata.get('detector_size_x', 'N/A')} × {metadata.get('detector_size_y', 'N/A')}")
