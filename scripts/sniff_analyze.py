...
Pairs with ``scripts/flush_pacing_listener.py``.  Given:
...
Usage::
    ...
    python scripts/sniff_analyze.py /tmp/sniff_NNN.pcap
    python scripts/sniff_analyze.py /tmp/sniff_NNN.pcap --listener /tmp/flush_pacing_NNN.json
    python scripts/sniff_analyze.py /tmp/sniff_NNN.pcap --bin 0.1   # 100 ms bins
