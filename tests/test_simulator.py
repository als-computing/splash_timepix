...
from splash_timepix.simulator import (
    PacketBuilder,
    PacketSimulator,
    SimulatorConfig,
    PacketType,
...
class TestPacketBuilder:
    ...
    def test_build_pixel_packet_structure(self, parser):
        ...
        packet_bytes = PacketBuilder.build_pixel_packet(
            timestamp=1000,
            tot=100,
            x=128,
            y=64,
    ...
    def test_build_tdc_packet_structure(self, parser):
        ...
        packet_bytes = PacketBuilder.build_tdc_packet(
            timestamp=2000,
            channel=1,
            edge=0,  # rising
            reserved=0
    ...
    def test_build_control_packet_structure(self, parser):
        ...
        packet_bytes = PacketBuilder.build_control_packet(
            timestamp=3000,
...
class TestSimulatorConfig:
    ...
    def test_default_config_values(self):
        ...
        assert config.include_control_packets == False
